...
def configure():
    ...
    flags.DEFINE_integer('save_interval', 30, 'number of iterations for saving and visualization')
    ...
    flags.DEFINE_string('pretrain_file', './pre_model/deeplab_resnet.ckpt', 'encoder_name pre-trained model filename ')
    flags.DEFINE_string('data_list', './dataset/train.txt', 'training data list filename')

    # validation
    flags.DEFINE_integer('valid_step', 0, 'checkpoint number for validation')
    ...
    flags.DEFINE_integer('test_step', 0, 'checkpoint number for testing/validation')
    ...
    # data
    flags.DEFINE_string('data_dir', 'C:\\ALISURE\\Data\\voc\\VOCdevkit\\VOC2012', 'data directory')
