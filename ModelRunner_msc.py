...
class ModelRunnerMsc(object):
    ...
    def train_setup(self):
        ...
        # Loss function
        self.reduced_loss = (tf.reduce_mean(loss) + tf.reduce_mean(loss100) + tf.reduce_mean(loss075) +
                             tf.reduce_mean(loss05) + tf.add_n(l2_losses))
    ...
    def test_setup(self):
        ...
        # mIoU
        self.mIoU, self.mIou_update_op = tcm.streaming_mean_iou(self.pred, gt, self.conf.num_classes, weights=weights)
