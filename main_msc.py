...
from ModelRunner_msc import ModelRunnerMsc
...
def configure():
    ...
    flags.DEFINE_string('pretrain_file', '../reference model/deeplab_resnet_init.ckpt',
...
def main(_):
    ...
    parser.add_argument('--option', dest='option', type=str, default='train', help='train, test, or predict')
    ...
    if args.option not in ['train', 'test', 'predict']:
        ...
        model = ModelRunnerMsc(sess, configure())
